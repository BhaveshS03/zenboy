...
Instructions::Instructions() {
    // Note: It's assumed the InstructionData struct has the following member order:
    // IN type, AM addressing_mode, RT reg1, RT reg2, CT cond, std::uint8_t param
    // with default values for reg1, reg2, cond, and param.
